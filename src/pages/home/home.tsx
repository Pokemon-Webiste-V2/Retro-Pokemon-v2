...
const paragraphText = `This project was born from a love of classic Game Boy adventures and the charm of their simple,
      ...
      <div className="first-body">
        ...
        <div>
          <h3 className="subtitle">
            Step into a retro-styled Pokémon battleground where classic arcade
            vibes meet real-time online battles. Challenge players worldwide and
            prove you’re the ultimate trainer.
          </h3>
        </div>
      </div>
      <div className="second-body">
        <TextHolder title="Introducing the Idea" paragraph={paragraphText} />
        <img src={images.GameBoy} alt="Gameboy" width="290px" height="500px" />
      </div>
    </div>
  );
}
