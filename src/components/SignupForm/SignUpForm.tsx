    ...
    return (   
     <LoginContainer>
        <LoginForm onSubmit={(e) => SubmitForm(e)} autoComplete="on">
             ...
             <input type="text" id="username" name="username"  value={formData?.username} onChange={(e) => handleForm(e)} autoFocus required/>
             <label >Email</label>
             <input type="text" id="email" name="email" pattern="" value={formData?.email} onChange={(e) => handleForm(e)} required/>
             <label >Password</label>
             <input type="password" id="password" name="password"  value={formData?.password} onChange={(e) => handleForm(e)} required/>
             <label >checkbox</label>
             <input type="checkbox" id="checkbox" name="checkbox" onChange={(e) => handleForm(e)} />
        </LoginForm>
        {error}
