    ...
    return (
        <Container>
            <ul>
                ...
                <li>
                    <button aria-label="Page" onClick={() => NextPage(counter)}>{counter + 1}</button>
                </li>
                <li>
                    <button aria-label="Page" onClick={() => NextPage(counter + 1)}>{counter + 2}</button>
                </li>
                <li>
                    <button aria-label="Page" onClick={() => NextPage(counter + 2)}>{counter + 3}</button>
                </li>
